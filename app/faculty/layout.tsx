    ...
    <div className="flex flex-1 flex-col md:flex-row">
      <aside className="bg-brand-900 md:w-64 md:shrink-0">
        <div className="space-y-2 border-b border-white/10 px-4 py-4">
          ...
          <p className="text-xs font-medium tracking-wide text-gold-300 uppercase">Faculty</p>
        </div>
        <nav className="flex gap-1 overflow-x-auto px-2 py-3 md:flex-col md:overflow-visible">
          <NavLink href="/faculty" exact>
            Dashboard
          </NavLink>
          <NavLink href="/faculty/courses">My Courses</NavLink>
          <NavLink href="/faculty/students">My Students</NavLink>
        </nav>
      </aside>
