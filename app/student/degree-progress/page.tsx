...
export default async function StudentDegreeProgressPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50">Degree Progress</h1>
        <p className="text-sm text-zinc-500 dark:text-zinc-400">Coursework and degree-audit summary</p>
      </div>

      {!audit ? (
        <p className="text-sm text-zinc-500 dark:text-zinc-400">Degree audit unavailable.</p>
      ) : (
        <>
