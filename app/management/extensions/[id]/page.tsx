    ...
    <div className="space-y-6">
      ...
      {application.reason && (
        <section className="space-y-2">
          <h2 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300">Reason</h2>
      ...
      {(application.recommendation || application.remarks) && (
        <section className="space-y-2">
          <h2 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300">Prior Review Notes</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300">Review</h2>
