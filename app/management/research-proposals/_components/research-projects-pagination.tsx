...
import { buildResearchProjectsHref, type ResearchProjectFilters } from "@/lib/management/research-proposals";
...
export function ResearchProjectsPagination({
  filters,
  page,
  totalPages,
}: {
    ...
    <div className="flex items-center justify-between border-t border-slate-200 pt-4 dark:border-slate-800">
      ...
      <div className="flex gap-2">
        {page <= 1 ? (
          ...
          <Link href={buildResearchProjectsHref(filters, page - 1)} className={buttonClasses}>
            Previous
          </Link>
        )}
        {page >= totalPages ? (
