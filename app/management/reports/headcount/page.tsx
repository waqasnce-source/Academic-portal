    ...
    <div className="space-y-6">
      ...
      {summary.error ? (
        ...
        <div className="space-y-8">
          ...
          <div>
            <h2 className="text-sm font-medium text-slate-700 dark:text-slate-300">By role</h2>
            <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {summary.byRole.map((r) => (
                ...
                >
                  <p className="text-sm text-slate-500 dark:text-slate-400">{ROLE_LABELS[r.role]}</p>
          ...
          <div>
            <h2 className="text-sm font-medium text-slate-700 dark:text-slate-300">By status</h2>
            <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {summary.byStatus.map((s) => (
                <div
                  ...
                  className="rounded-lg border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-950"
                >
                  <p className="text-sm text-slate-500 dark:text-slate-400">{STATUS_LABELS[s.status]}</p>
                  <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-50">
