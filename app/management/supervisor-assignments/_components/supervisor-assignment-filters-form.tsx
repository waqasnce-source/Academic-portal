...
import {
  ...
  SUPERVISOR_ASSIGNMENT_STATUSES,
  type SupervisorAssignmentFilters,
...
export function SupervisorAssignmentFiltersForm({ filters }: { filters: SupervisorAssignmentFilters }) {
  return (
    <form
      method="GET"
    ...
    >
      <div className="flex min-w-[140px] flex-col gap-1">
        ...
        <select id="status" name="status" defaultValue={filters.status} className={fieldClasses}>
          ...
          {SUPERVISOR_ASSIGNMENT_STATUSES.map((s) => (
